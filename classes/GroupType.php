...
class GroupType extends ItemTypeBase implements ItemType {
	...
	public function get_labels() {
		$map = array(
			'course'    => array(
				...
				'status_open_no_join_community_site',
				'status_open_private_site',
				'status_open_no_join_private_site',
				'status_private',
				'status_private_no_requests',
				'status_private_no_requests_open_site',
				'status_private_community_site',
				'status_private_no_requests_community_site',
				'status_private_open_site',
				'status_private_private_site',
				'status_private_no_requests_private_site',
				'site_help_text',
	 ...
	 * 1. Add entry here
	 * 2. Add entry in get_label_types_info()
	 * 2. Add slug to each group type in get_labels()
	 * 3. Add default values to types in get_all_group_type_default_labels()
	...
	public function get_label_types() {
		return array(
			...
			'status_open_no_join'                       => array(
				'value' => '',
			),
			'status_open_community_site'                => array(
				'value' => '',
			),
			'status_open_no_join_community_site'        => array(
				'value' => '',
			),
			'status_open_private_site'                  => array(
				'value' => '',
			),
			'status_open_no_join_private_site'          => array(
				'value' => '',
			),
			'status_private'                            => array(
				'value' => '',
			),
			'status_private_no_requests'                => array(
				'value' => '',
			),
			'status_private_no_requests_open_site'      => array(
				'value' => '',
			),
			'status_private_community_site'             => array(
				'value' => '',
			),
			'status_private_no_requests_community_site' => array(
				'value' => '',
			),
			...
			'status_private_no_requests_private_site'   => array(
				'value' => '',
			),
	...
	public function get_label_types_info() {
		return array(
			...
			'status_open_no_join'                       => array(
				'slug'        => 'status_open_no_join',
				'label'       => _x( 'Status: Open, No Join', 'Group Type label', 'commons-in-a-box' ),
				'description' => __( 'Used to describe a group that is open but does not allow joining.', 'commons-in-a-box' ),
			),
			'status_open_community_site'                => array(
			...
			'status_open_no_join_community_site'        => array(
				'slug'        => 'status_open_no_join_community_site',
				'label'       => _x( 'Status: Open, No Join, Community Site', 'Group Type label', 'commons-in-a-box' ),
				'description' => __( 'Used to describe a group that is open, does not allow joining, and has a site that is visible only to community members.', 'commons-in-a-box' ),
			),
			'status_open_private_site'                  => array(
			...
			'status_open_no_join_private_site'          => array(
				'slug'        => 'status_open_no_join_private_site',
				'label'       => _x( 'Status: Open, No Join, Private Site', 'Group Type label', 'commons-in-a-box' ),
				'description' => __( 'Used to describe a group that is open, does not allow joining, and has a site that is private.', 'commons-in-a-box' ),
			),
			'status_private'                            => array(
				'slug'        => 'status_private',
			...
			'status_private_no_requests'                => array(
				'slug'        => 'status_private_no_requests',
				'label'       => _x( 'Status: Private, No Requests', 'Group Type label', 'commons-in-a-box' ),
				'description' => __( 'Used to describe a group that is private and does not allow membership requests.', 'commons-in-a-box' ),
			),
			'status_private_no_requests_open_site'      => array(
				'slug'        => 'status_private_no_requests_open_site',
				'label'       => _x( 'Status: Private, No Requests, Open Site', 'Group Type label', 'commons-in-a-box' ),
				'description' => __( 'Used to describe a group that is private, does not allow membership requests, and has an open site.', 'commons-in-a-box' ),
			),
			'status_private_community_site'             => array(
			...
			'status_private_no_requests_community_site' => array(
				'slug'        => 'status_private_no_requests_community_site',
				'label'       => _x( 'Status: Private, No Requests, Community Site', 'Group Type label', 'commons-in-a-box' ),
				'description' => __( 'Used to describe a group that is private, does not allow membership requests, and has a site that is visible only to community members.', 'commons-in-a-box' ),
			),
			'status_private_open_site'                  => array(
			...
			'status_private_no_requests_private_site'   => array(
				'slug'        => 'status_private_no_requests_private_site',
				'label'       => _x( 'Status: Private, No Requests, Private Site', 'Group Type label', 'commons-in-a-box' ),
				'description' => __( 'Used to describe a group that is private, does not allow membership requests, and has a site that is private.', 'commons-in-a-box' ),
			),
			'visit_group_site'                          => array(
	...
	public static function get_all_group_type_default_labels() {
		return [
			'course'    => array(
				...
				'status_open_no_join'                     => __( 'This Course is OPEN but membership is by invitation.', 'commons-in-a-box' ),
				...
				'status_open_no_join_community_site'      => __( 'This Course is OPEN and membership is by invitation only, but only logged-in community members members may view the corresponding Site.', 'commons-in-a-box' ),
				'status_open_private_site'                => __( 'This Course is OPEN, but the corresponding Site is PRIVATE.', 'commons-in-a-box' ),
				'status_open_no_join_private_site'        => __( 'This Course is OPEN but membership is by invitation only. The corresponding Site is PRIVATE.', 'commons-in-a-box' ),
				'status_private'                          => __( 'This Course is PRIVATE.', 'commons-in-a-box' ),
				'status_private_no_requests'              => __( 'This Course is PRIVATE and membership is by invitation only.', 'commons-in-a-box' ),
				'status_private_no_requests_open_site'    => __( 'This Course is PRIVATE and membership is by invitation only, but the corresponding Site is OPEN to all visitors.', 'commons-in-a-box' ),
				...
				'status_private_no_requests_community_site' => __( 'This Course is PRIVATE and membership is by invitation only, but all logged-in community members may view the corresponding Site.', 'commons-in-a-box' ),
				...
				'status_private_no_requests_private_site' => __( 'This Course is PRIVATE and membership is by invitation only. You must be a member to view the corresponding Site.', 'commons-in-a-box' ),
			...
			'project'   => array(
				...
				'status_open_no_join'                     => __( 'This Project is OPEN but membership is by invitation.', 'commons-in-a-box' ),
				...
				'status_open_no_join_community_site'      => __( 'This Project is OPEN and membership is by invitation only, but only logged-in community members members may view the corresponding Site.', 'commons-in-a-box' ),
				'status_open_private_site'                => __( 'This Project is OPEN, but the corresponding Site is PRIVATE.', 'commons-in-a-box' ),
				'status_open_no_join_private_site'        => __( 'This Project is OPEN but membership is by invitation only. The corresponding Site is PRIVATE.', 'commons-in-a-box' ),
				'status_private'                          => __( 'This Project is PRIVATE.', 'commons-in-a-box' ),
				'status_private_no_requests'              => __( 'This Project is PRIVATE and membership is by invitation only.', 'commons-in-a-box' ),
				'status_private_no_requests_open_site'    => __( 'This Project is PRIVATE and membership is by invitation only, but the corresponding Site is OPEN to all visitors.', 'commons-in-a-box' ),
				...
				'status_private_no_requests_community_site' => __( 'This Project is PRIVATE and membership is by invitation only, but all logged-in community members may view the corresponding Site.', 'commons-in-a-box' ),
				...
				'status_private_no_requests_private_site' => __( 'This Project is PRIVATE and membership is by invitation only. You must be a member to view the corresponding Site.', 'commons-in-a-box' ),
			...
			'club'      => array(
				...
				'status_open_no_join'                     => __( 'This Club is OPEN but membership is by invitation.', 'commons-in-a-box' ),
				...
				'status_open_no_join_community_site'      => __( 'This Club is OPEN and membership is by invitation only, but only logged-in community members members may view the corresponding Site.', 'commons-in-a-box' ),
				'status_open_private_site'                => __( 'This Club is OPEN, but the corresponding Site is PRIVATE.', 'commons-in-a-box' ),
				'status_open_no_join_private_site'        => __( 'This Club is OPEN but membership is by invitation only. The corresponding Site is PRIVATE.', 'commons-in-a-box' ),
				'status_private'                          => __( 'This Club is PRIVATE.', 'commons-in-a-box' ),
				'status_private_no_requests'              => __( 'This Club is PRIVATE and membership is by invitation only.', 'commons-in-a-box' ),
				'status_private_no_requests_open_site'    => __( 'This Club is PRIVATE and membership is by invitation only, but the corresponding Site is OPEN to all visitors.', 'commons-in-a-box' ),
				...
				'status_private_no_requests_community_site' => __( 'This Club is PRIVATE and membership is by invitation only, but all logged-in community members may view the corresponding Site.', 'commons-in-a-box' ),
				...
				'status_private_no_requests_private_site' => __( 'This Club is PRIVATE and membership is by invitation only. You must be a member to view the corresponding Site.', 'commons-in-a-box' ),
			...
			'portfolio' => array(
				...
				'status_open_no_join'                     => __( 'This Portfolio is OPEN but membership is by invitation.', 'commons-in-a-box' ),
				...
				'status_open_no_join_community_site'      => __( 'This Portfolio is OPEN and membership is by invitation only, but only logged-in community members members may view the corresponding Site.', 'commons-in-a-box' ),
				'status_open_private_site'                => __( 'This Portfolio is OPEN, but the corresponding Site is PRIVATE.', 'commons-in-a-box' ),
				'status_open_no_join_private_site'        => __( 'This Portfolio is OPEN but membership is by invitation only. The corresponding Site is PRIVATE.', 'commons-in-a-box' ),
				'status_private'                          => __( 'This Portfolio is PRIVATE.', 'commons-in-a-box' ),
				'status_private_no_requests'              => __( 'This Portfolio is PRIVATE and membership is by invitation only.', 'commons-in-a-box' ),
				'status_private_no_requests_open_site'    => __( 'This Portfolio is PRIVATE and membership is by invitation only, but the corresponding Site is OPEN to all visitors.', 'commons-in-a-box' ),
				...
				'status_private_no_requests_community_site' => __( 'This Portfolio is PRIVATE and membership is by invitation only, but all logged-in community members may view the corresponding Site.', 'commons-in-a-box' ),
				...
				'status_private_no_requests_private_site' => __( 'This Portfolio is PRIVATE and membership is by invitation only. You must be a member to view the corresponding Site.', 'commons-in-a-box' ),
