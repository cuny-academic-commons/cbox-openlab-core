...
class Install {
	...
	/**
	 * Returns a definition of default group types.
	 *
	 * @since 1.7.0
	 *
	 * @return array
	 */
	public static function get_default_group_type_definitions() {
		$types_data = array(
			'course'    => array(
				...
				'labels'                           => GroupType::get_group_type_default_labels( 'course' ),
				'can_be_cloned'                    => true,
			...
			'project'   => array(
				...
				'labels'                           => GroupType::get_group_type_default_labels( 'project' ),
				'can_be_cloned'                    => true,
			...
			'club'      => array(
				...
				'labels'                           => GroupType::get_group_type_default_labels( 'club' ),
				'can_be_cloned'                    => true,
				'directory_filters'                => array( 'category' ),
				'enable_portfolio_list_by_default' => false,
				'enable_site_by_default'           => false,
			...
			'portfolio' => array(
				...
				'labels'                           => GroupType::get_group_type_default_labels( 'portfolio' ),
				'can_be_cloned'                    => false,
	...
	public function install_default_group_types() {
		$types_data = self::get_default_group_type_definitions();
...
<p>' . $left_text . '</p>
	 ...
	 */
	protected static function get_default_theme() {
		$default = null;
