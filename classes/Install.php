		...
		$types_data = array(
			'course' => array(
				...
				'labels' => array(
					...
					'privacy_help_text_public_content' => __( 'Course and related content will be visible to the public.', 'cbox-openlab-core' ),
					...
					'privacy_help_text_private_content' => __( 'Course and related content and activity will only be visible to members of the course.', 'cbox-openlab-core' ),
			...
			'portfolio' => array(
				...
				'labels' => array(
					...
					'privacy_help_text_public_content' => __( 'Portfolio and related content will be visible to the public.', 'cbox-openlab-core' ),
					...
					'privacy_help_text_private_content' => __( 'Portfolio and related content and activity will only be visible to members of the portfolio.', 'cbox-openlab-core' ),
			...
			'club' => array(
				...
				'labels' => array(
					...
					'privacy_help_text_public_content' => __( 'Club and related content will be visible to the public.', 'cbox-openlab-core' ),
					...
					'privacy_help_text_private_content' => __( 'Club and related content and activity will only be visible to members of the club.', 'cbox-openlab-core' ),
			...
			'project' => array(
				...
				'labels' => array(
					...
					'privacy_help_text_public_content' => __( 'Project and related content will be visible to the public.', 'cbox-openlab-core' ),
					...
					'privacy_help_text_private_content' => __( 'Project and related content and activity will only be visible to members of the project.', 'cbox-openlab-core' ),
