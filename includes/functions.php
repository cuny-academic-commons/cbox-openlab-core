 ...
 *
 * Formerly a part of openlab-theme, it's moved here for better availability during
 * installation. It's wrapped in a `function_exists()` call to avoid fatal errors
 * during upgrade from older versions of openlab-theme.
 */
if ( ! function_exists( 'openlab_get_current_filter' ) ) {
