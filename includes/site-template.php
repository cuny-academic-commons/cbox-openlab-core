...
function cboxol_register_site_template_assets() {
	wp_register_style(
		...
		plugins_url( 'build/site-templates.css', CBOXOL_PLUGIN_ROOT_FILE ),
		[],
		CBOXOL_ASSET_VER
	);
	...
	wp_register_script(
		...
		plugins_url( 'build/site-templates.js', CBOXOL_PLUGIN_ROOT_FILE ),
		[],
		CBOXOL_ASSET_VER,
		true
	);
...
function cboxol_load_site_template_view( $name = '', array $data = [] ) {
	$path = CBOXOL_PLUGIN_DIR . 'views/site-template/' . $name;
