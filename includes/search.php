...
/**
 * Modifications to the way that BuddyPress group search works.
 *
 * @since 1.3.0
 */

/**
 * Rebuilds the SQL used by BuddyPress to process group searches.
 *
 * @since 1.3.0
 *
 * @param string $sql SQL string.
 * @param string $s   Search term.
 * @param array  $r   Parameters passed to the query function.
 */
function cboxol_group_search_breakup( $sql, $s, $r ) {
...
add_filter( 'bp_groups_get_paged_groups_sql', 'cboxol_group_search_breakup', 10, 3 );
add_filter( 'bp_groups_get_total_groups_sql', 'cboxol_group_search_breakup', 10, 3 );
