...
async function getSiteTemplates(category) {
  ...
  let groupId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
...
function updateTemplates(category, page) {
  ...
  (0,_api__WEBPACK_IMPORTED_MODULE_0__.getSiteTemplates)(category, page, groupId).then(_ref2 => {
    let {
      templates,
      prev,
      next
