...
if ( ! class_exists( 'BPCGC_Groups_Terms' ) ) :

	class BPCGC_Groups_Terms {
		 ...
		 * @static
		 */
		public static function update_term_count( $terms, $taxonomy = 'bp_group_categories' ) {
			global $wpdb;
			$bp = buddypress();
		 ...
		 */
		public static function get_object_terms( $object_ids, $taxonomies = 'bp_group_categories', $args = array() ) {
			global $wpdb;
			self::set_tables();
		 ...
		 */
		public static function set_object_terms( $object_id, $terms, $taxonomy = 'bp_group_categories', $append = false ) {
			global $wpdb;
			self::set_tables();
		 ...
		 */
		public static function remove_object_terms( $object_id, $terms, $taxonomy = 'bp_group_categories' ) {
			global $wpdb;
			self::set_tables();
		 ...
		 */
		public static function delete_object_term_relationships( $object_id, $taxonomies = 'bp_group_categories' ) {
			global $wpdb;
			self::set_tables();
		 ...
		 */
		public static function get_objects_in_term( $term_ids, $taxonomies = 'bp_group_categories', $args = array() ) {
			global $wpdb;
			self::set_tables();
		 ...
		 * @uses get_terms()
		 */
		public static function get_terms( $taxonomies = 'bp_group_categories', $args = '' ) {
			global $wpdb;
			self::set_tables();
		 ...
		 * @uses get_term_by()
		 */
		public static function get_term_by( $field, $value, $taxonomy = 'bp_group_categories', $output = OBJECT, $filter = 'raw' ) {
			global $wpdb;
			self::set_tables();
		 ...
		 * @uses get_term_link()
		 */
		public static function get_term_link( $term, $taxonomy = 'bp_group_categories' ) {
			global $wpdb;
			self::set_tables();
		 ...
		 */
		public static function get_the_term_list( $group_id, $taxonomy = 'bp_group_categories', $before = '', $sep = '', $after = '', $description = 0 ) {
...
add_action( 'bp_init', array( 'BPCGC_Groups_Terms', 'start' ), 11 );
