...
var store = new _vuex2.default.Store({
	...
	mutations: {
		...
		setMayImportGroupUsers: function setMayImportGroupUsers(state, payload) {
...
},{"./components/CBOXOLAdmin.vue":5,"isomorphic-fetch":119,"vue":125,"vuex":130}],2:[function(require,module,exports){
;(function(){
'use strict';
...
},{"./EntityList.vue":7,"vue":125,"vue-hot-reload-api":123}],3:[function(require,module,exports){
;(function(){
'use strict';
...
},{"./EntityList.vue":7,"vue":125,"vue-hot-reload-api":123}],4:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../mixins/EntityTools.js":30,"vue":125,"vue-hot-reload-api":123}],5:[function(require,module,exports){
;(function(){
'use strict';
...
},{"./AcademicTermsUI.vue":2,"./AcademicUnitsUI.vue":3,"./GroupCategoriesUI.vue":9,"./Registration.vue":13,"./TypesUI.vue":18,"vue":125,"vue-hot-reload-api":123}],6:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../mixins/i18nTools.js":32,"vue":125,"vue-hot-reload-api":123}],7:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../mixins/EntityTools.js":30,"./AddNewEntityLink.vue":4,"./EntityListItem.vue":8,"classnames":118,"vue":125,"vue-hot-reload-api":123,"vuedraggable":128}],8:[function(require,module,exports){
;(function(){
'use strict';
...
var _MayImportGroupUsers = require('./settings/MayImportGroupUsers.vue');

var _MayImportGroupUsers2 = _interopRequireDefault(_MayImportGroupUsers);
...
exports.default = {
	components: {
		...
		MayImportGroupUsers: _MayImportGroupUsers2.default,
	...
	computed: {
		...
		allCollaborationToolsOptions: function allCollaborationToolsOptions() {
			return new _map2.default([['discussion', this.strings.discussion, this.strings.discussionGloss], ['docs', this.strings.docs, this.strings.docsGloss], ['files', this.strings.fileLibrary, this.strings.fileLibraryGloss]]);
		},
		allSiteBlogPublicOptions: function allSiteBlogPublicOptions() {
			return new _map2.default([['1', this.strings.groupSiteBlogPublic1], ['0', this.strings.groupSiteBlogPublic0], ['-1', this.strings.groupSiteBlogPublicNegative1], ['-2', this.strings.groupSiteBlogPublicNegative2], ['-3', this.strings.groupSiteBlogPublicNegative3]]);
		},
		...
		selectedCollaborationTools: {
			get: function get() {
				var rawOptions = this.entityData.defaultCollaborationTools || [];
				var optionOrder = ['discussion', 'docs', 'files'];

				var sortedOptions = optionOrder.reduce(function (acc, option) {
		...
		selectedPrivacyOptions: function selectedPrivacyOptions() {
			var rawOptions = this.entityData.availablePrivacyOptions || [];
			var optionOrder = ['public', 'private', 'hidden'];
		...
		selectedSitePrivacyOptions: {
			get: function get() {
				var rawOptions = this.entityData.availableSitePrivacyOptions || [];

				var optionOrder = ['1', '0', '-1', '-2', '-3'];
	...
	methods: {
		...
		privacyLabel: function privacyLabel(option) {
			var labels = {
		...
		sitePrivacyLabel: function sitePrivacyLabel(option) {
	...
	watch: {
		selectedPrivacyOptions: {
			handler: function handler(newOptions) {
				var currentDefault = this.defaultPrivacy;
				var original = this.originalDefault;

				var currentIsValid = newOptions.includes(currentDefault);
				var originalIsValid = newOptions.includes(original);

				if (!currentIsValid) {
					var newDefault = originalIsValid && !this.isDefaultDirty ? original : newOptions[0] || '';
		...
		selectedSitePrivacyOptions: {
			handler: function handler(newOptions) {
				var currentDefault = this.defaultSitePrivacy;
				var original = this.originalSiteDefault;

				var currentIsValid = newOptions.includes(currentDefault);
				var originalIsValid = newOptions.includes(original);

				if (!currentIsValid) {
					var newDefault = originalIsValid && !this.isSiteDefaultDirty ? original : newOptions[0] || '';
...
},{"../mixins/AjaxTools.js":29,"../mixins/EntityTools.js":30,"../mixins/i18nTools.js":32,"./OnOffSwitch.vue":12,"./TypeLabel.vue":17,"./settings/AcademicUnits.vue":21,"./settings/AssociatedGroupTypeCheckboxes.vue":22,"./settings/AssociatedTypeDropdowns.vue":24,"./settings/MayChangeMemberTypeTo.vue":25,"./settings/MayCreateCourses.vue":26,"./settings/MayImportGroupUsers.vue":27,"./settings/Order.vue":28,"babel-runtime/core-js/map":33,"vue":125,"vue-hot-reload-api":123}],9:[function(require,module,exports){
;(function(){
'use strict';
...
},{"./EntityList.vue":7,"vue":125,"vue-hot-reload-api":123}],10:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../mixins/AjaxTools.js":29,"../mixins/i18nTools.js":32,"vue":125,"vue-hot-reload-api":123}],11:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../mixins/AjaxTools.js":29,"../mixins/SignupCodeTools.js":31,"../mixins/i18nTools.js":32,"./SignupCodeGroupSelector.vue":14,"./SignupCodeMemberTypeSelector.vue":15,"vue":125,"vue-hot-reload-api":123}],12:[function(require,module,exports){
...
},{"../mixins/EntityTools.js":30,"../mixins/i18nTools.js":32,"vue":125,"vue-hot-reload-api":123,"vueify/lib/insert-css":129}],13:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../mixins/i18nTools.js":32,"./EmailDomainRow.vue":6,"./NewEmailDomain.vue":10,"./NewSignupCode.vue":11,"./SignupCodeRow.vue":16,"babel-runtime/core-js/object/keys":35,"vue":125,"vue-hot-reload-api":123}],14:[function(require,module,exports){
...
},{"../mixins/i18nTools.js":32,"vue":125,"vue-hot-reload-api":123,"vue2-autocomplete-js":127,"vueify/lib/insert-css":129}],15:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../mixins/i18nTools.js":32,"vue":125,"vue-hot-reload-api":123}],16:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../mixins/AjaxTools.js":29,"../mixins/SignupCodeTools.js":31,"../mixins/i18nTools.js":32,"./SignupCodeGroupSelector.vue":14,"./SignupCodeMemberTypeSelector.vue":15,"vue":125,"vue-hot-reload-api":123}],17:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../mixins/EntityTools.js":30,"../mixins/i18nTools.js":32,"vue":125,"vue-hot-reload-api":123}],18:[function(require,module,exports){
;(function(){
'use strict';
...
},{"./EntityList.vue":7,"vue":125,"vue-hot-reload-api":123}],19:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../../mixins/i18nTools.js":32,"./AcademicUnitParentSelector.vue":20,"vue":125,"vue-hot-reload-api":123}],20:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../../mixins/i18nTools.js":32,"vue":125,"vue-hot-reload-api":123}],21:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../../mixins/i18nTools.js":32,"./AcademicUnit.vue":19,"./AcademicUnitParentSelector.vue":20,"vue":125,"vue-hot-reload-api":123}],22:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../../mixins/EntityTools.js":30,"vue":125,"vue-hot-reload-api":123}],23:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../../mixins/EntityTools.js":30,"../../mixins/i18nTools.js":32,"babel-runtime/core-js/object/assign":34,"vue":125,"vue-hot-reload-api":123}],24:[function(require,module,exports){
;(function(){
'use strict';
...
},{"./AssociatedTypeDropdown.vue":23,"vue":125,"vue-hot-reload-api":123}],25:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../../mixins/EntityTools.js":30,"../../mixins/i18nTools.js":32,"vue":125,"vue-hot-reload-api":123}],26:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../../mixins/EntityTools.js":30,"../../mixins/i18nTools.js":32,"vue":125,"vue-hot-reload-api":123}],27:[function(require,module,exports){
;(function(){
'use strict';
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"cboxol-item-type-setting"},[_c('fieldset',[_c('div',{staticClass:"cboxol-setting-label"},[_c('legend',[_vm._v(_vm._s(_vm.strings.mayImportGroupUsersLegend))])]),_vm._v(" "),_c('div',{staticClass:"cboxol-setting-content"},[_c('label',{attrs:{"for":'may-import-group-users-no-' + _vm.slug}},[_vm._v("\n\t\t\t\t"+_vm._s(_vm.strings.no)+"\n\t\t\t\t"),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.mayImportGroupUsers),expression:"mayImportGroupUsers"}],attrs:{"type":"radio","value":"no","name":'may-import-group-users-' + _vm.slug,"id":'may-import-group-users-no-' + _vm.slug},domProps:{"checked":_vm._q(_vm.mayImportGroupUsers,"no")},on:{"change":function($event){_vm.mayImportGroupUsers="no"}}})]),_vm._v(" "),_c('label',{attrs:{"for":'may-import-group-users-yes-' + _vm.slug}},[_vm._v("\n\t\t\t\t"+_vm._s(_vm.strings.yes)+"\n\t\t\t\t"),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.mayImportGroupUsers),expression:"mayImportGroupUsers"}],attrs:{"type":"radio","value":"yes","name":'may-import-group-users-' + _vm.slug,"id":'may-import-group-users-yes-' + _vm.slug},domProps:{"checked":_vm._q(_vm.mayImportGroupUsers,"yes")},on:{"change":function($event){_vm.mayImportGroupUsers="yes"}}})])])])])}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-58830b5e", __vue__options__)
  } else {
    hotAPI.reload("data-v-58830b5e", __vue__options__)
  }
})()}
},{"../../mixins/EntityTools.js":30,"../../mixins/i18nTools.js":32,"vue":125,"vue-hot-reload-api":123}],28:[function(require,module,exports){
;(function(){
'use strict';
...
},{"../../mixins/EntityTools.js":30,"../../mixins/i18nTools.js":32,"vue":125,"vue-hot-reload-api":123}],29:[function(require,module,exports){
'use strict';
...
},{"./i18nTools.js":32}],31:[function(require,module,exports){
'use strict';
...
},{"core-js/library/fn/map":36}],34:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/assign"), __esModule: true };
},{"core-js/library/fn/object/assign":37}],35:[function(require,module,exports){
module.exports = { "default": require("core-js/library/fn/object/keys"), __esModule: true };
},{"core-js/library/fn/object/keys":38}],36:[function(require,module,exports){
...
},{"../modules/_core":53,"../modules/es6.map":109,"../modules/es6.object.to-string":112,"../modules/es6.string.iterator":113,"../modules/es7.map.from":114,"../modules/es7.map.of":115,"../modules/es7.map.to-json":116,"../modules/web.dom.iterable":117}],37:[function(require,module,exports){
require('../../modules/es6.object.assign');
module.exports = require('../../modules/_core').Object.assign;

},{"../../modules/_core":53,"../../modules/es6.object.assign":110}],38:[function(require,module,exports){
require('../../modules/es6.object.keys');
module.exports = require('../../modules/_core').Object.keys;

},{"../../modules/_core":53,"../../modules/es6.object.keys":111}],39:[function(require,module,exports){
...
},{"./_is-object":70}],43:[function(require,module,exports){
...
},{"./_for-of":61}],44:[function(require,module,exports){
// false -> Array#indexOf
// true  -> Array#includes
...
},{"./_to-absolute-index":98,"./_to-iobject":100,"./_to-length":101}],45:[function(require,module,exports){
// 0 -> Array#forEach
// 1 -> Array#map
// 2 -> Array#filter
// 3 -> Array#some
...
},{"./_array-species-create":47,"./_ctx":54,"./_iobject":67,"./_to-length":101,"./_to-object":102}],46:[function(require,module,exports){
var isObject = require('./_is-object');
...
},{"./_is-array":69,"./_is-object":70,"./_wks":106}],47:[function(require,module,exports){
...
},{"./_an-instance":41,"./_ctx":54,"./_descriptors":56,"./_for-of":61,"./_iter-define":73,"./_iter-step":74,"./_meta":77,"./_object-create":79,"./_object-dp":80,"./_redefine-all":89,"./_set-species":93,"./_validate-collection":105}],51:[function(require,module,exports){
...
},{"./_an-instance":41,"./_array-methods":45,"./_descriptors":56,"./_export":59,"./_fails":60,"./_for-of":61,"./_global":62,"./_hide":64,"./_is-object":70,"./_meta":77,"./_object-dp":80,"./_redefine-all":89,"./_set-to-string-tag":94}],53:[function(require,module,exports){
...
},{"./_fails":60}],57:[function(require,module,exports){
var isObject = require('./_is-object');
...
},{"./_core":53,"./_ctx":54,"./_global":62,"./_has":63,"./_hide":64}],60:[function(require,module,exports){
...
},{"./_an-object":42,"./_ctx":54,"./_is-array-iter":68,"./_iter-call":71,"./_to-length":101,"./core.get-iterator-method":107}],62:[function(require,module,exports){
...
},{"./_descriptors":56,"./_object-dp":80,"./_property-desc":88}],65:[function(require,module,exports){
var document = require('./_global').document;
...
},{"./_descriptors":56,"./_dom-create":57,"./_fails":60}],67:[function(require,module,exports){
...
},{"./_iterators":75,"./_wks":106}],69:[function(require,module,exports){
...
},{"./_hide":64,"./_object-create":79,"./_property-desc":88,"./_set-to-string-tag":94,"./_wks":106}],73:[function(require,module,exports){
'use strict';
...
},{"./_export":59,"./_hide":64,"./_iter-create":72,"./_iterators":75,"./_library":76,"./_object-gpo":83,"./_redefine":90,"./_set-to-string-tag":94,"./_wks":106}],74:[function(require,module,exports){
...
},{"./_fails":60,"./_has":63,"./_is-object":70,"./_object-dp":80,"./_uid":104}],78:[function(require,module,exports){
'use strict';
...
},{"./_descriptors":56,"./_fails":60,"./_iobject":67,"./_object-gops":82,"./_object-keys":85,"./_object-pie":86,"./_to-object":102}],79:[function(require,module,exports){
...
},{"./_an-object":42,"./_dom-create":57,"./_enum-bug-keys":58,"./_html":65,"./_object-dps":81,"./_shared-key":95}],80:[function(require,module,exports){
var anObject = require('./_an-object');
...
},{"./_an-object":42,"./_descriptors":56,"./_ie8-dom-define":66,"./_to-primitive":103}],81:[function(require,module,exports){
var dP = require('./_object-dp');
var anObject = require('./_an-object');
var getKeys = require('./_object-keys');
...
},{"./_an-object":42,"./_descriptors":56,"./_object-dp":80,"./_object-keys":85}],82:[function(require,module,exports){
...
},{"./_has":63,"./_shared-key":95,"./_to-object":102}],84:[function(require,module,exports){
var has = require('./_has');
var toIObject = require('./_to-iobject');
...
},{"./_array-includes":44,"./_has":63,"./_shared-key":95,"./_to-iobject":100}],85:[function(require,module,exports){
...
},{"./_enum-bug-keys":58,"./_object-keys-internal":84}],86:[function(require,module,exports){
...
},{"./_core":53,"./_export":59,"./_fails":60}],88:[function(require,module,exports){
...
},{"./_hide":64}],90:[function(require,module,exports){
...
},{"./_a-function":39,"./_ctx":54,"./_export":59,"./_for-of":61}],92:[function(require,module,exports){
'use strict';
// https://tc39.github.io/proposal-setmap-offrom/
var $export = require('./_export');
...
},{"./_export":59}],93:[function(require,module,exports){
'use strict';
var global = require('./_global');
var core = require('./_core');
var dP = require('./_object-dp');
...
},{"./_core":53,"./_descriptors":56,"./_global":62,"./_object-dp":80,"./_wks":106}],94:[function(require,module,exports){
...
},{"./_has":63,"./_object-dp":80,"./_wks":106}],95:[function(require,module,exports){
...
},{"./_core":53,"./_global":62,"./_library":76}],97:[function(require,module,exports){
...
},{"./_defined":55,"./_to-integer":99}],98:[function(require,module,exports){
var toInteger = require('./_to-integer');
var max = Math.max;
var min = Math.min;
...
},{"./_defined":55,"./_iobject":67}],101:[function(require,module,exports){
// 7.1.15 ToLength
var toInteger = require('./_to-integer');
var min = Math.min;
module.exports = function (it) {
...
},{"./_defined":55}],103:[function(require,module,exports){
...
},{"./_is-object":70}],104:[function(require,module,exports){
var id = 0;
var px = Math.random();
module.exports = function (key) {
...
},{"./_global":62,"./_shared":96,"./_uid":104}],107:[function(require,module,exports){
var classof = require('./_classof');
var ITERATOR = require('./_wks')('iterator');
var Iterators = require('./_iterators');
...
},{"./_classof":48,"./_core":53,"./_iterators":75,"./_wks":106}],108:[function(require,module,exports){
'use strict';
...
},{"./_add-to-unscopables":40,"./_iter-define":73,"./_iter-step":74,"./_iterators":75,"./_to-iobject":100}],109:[function(require,module,exports){
'use strict';
...
},{"./_collection":52,"./_collection-strong":50,"./_validate-collection":105}],110:[function(require,module,exports){
// 19.1.3.1 Object.assign(target, source)
var $export = require('./_export');

$export($export.S + $export.F, 'Object', { assign: require('./_object-assign') });

},{"./_export":59,"./_object-assign":78}],111:[function(require,module,exports){
...
},{"./_object-keys":85,"./_object-sap":87,"./_to-object":102}],112:[function(require,module,exports){
...
},{"./_iter-define":73,"./_string-at":97}],114:[function(require,module,exports){
// https://tc39.github.io/proposal-setmap-offrom/#sec-map.from
require('./_set-collection-from')('Map');

},{"./_set-collection-from":91}],115:[function(require,module,exports){
// https://tc39.github.io/proposal-setmap-offrom/#sec-map.of
require('./_set-collection-of')('Map');

},{"./_set-collection-of":92}],116:[function(require,module,exports){
// https://github.com/DavidBruant/Map-Set.prototype.toJSON
var $export = require('./_export');

$export($export.P + $export.R, 'Map', { toJSON: require('./_collection-to-json')('Map') });

},{"./_collection-to-json":51,"./_export":59}],117:[function(require,module,exports){
...
},{"./_global":62,"./_hide":64,"./_iterators":75,"./_wks":106,"./es6.array.iterator":108}],118:[function(require,module,exports){
/*!
...
},{"whatwg-fetch":131}],120:[function(require,module,exports){
...
},{"process/browser.js":120,"timers":122}],123:[function(require,module,exports){
var Vue // late bind
var version
...
},{"timers":122}],125:[function(require,module,exports){
...
},{"./vue.runtime.common.dev.js":124,"./vue.runtime.common.prod.js":126,"_process":120}],126:[function(require,module,exports){
(function (global,setImmediate){(function (){
/*!
 * Vue.js v2.7.14
 * (c) 2014-2022 Evan You
...
},{"timers":122}],127:[function(require,module,exports){
/*!
...
},{"sortablejs":121}],129:[function(require,module,exports){
...
},{"_process":120}],131:[function(require,module,exports){
(function (global, factory) {
